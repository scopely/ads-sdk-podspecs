...
Pod::Spec.new do |s|
  ...
  s.license      = { :type => 'MIT', :file => 'Scopely-Amazon-Test/3.0.1/LICENSE' }
  s.author       = { 'Jose Pinero' => 'jose.pinero@scopely.com' }
  s.source       = { :git => 'https://github.com/scopely/ads-sdk-podspecs.git' }

  s.ios.deployment_target = '8.0'
  s.static_framework = true
  s.vendored_frameworks = 'Scopely-Amazon-Test/3.0.1/SDK/DTBiOSSDK.framework'
end
