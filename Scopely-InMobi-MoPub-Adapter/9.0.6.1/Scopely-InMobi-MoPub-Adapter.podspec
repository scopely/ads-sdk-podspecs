...
Pod::Spec.new do |s|
  ...
  s.author           = { 'Carlos Castillo' => 'carlos.castillo@scopely.com' }
  s.source           = { :git => 'https://github.com/scopely/ads-sdk-podspecs.git' }

  s.ios.deployment_target = '8.0'
  s.static_framework = true
  s.source_files = 'Scopely-InMobi/9.0.6/InMobiAdapter/*.{h,m}'
  s.dependency 'mopub-ios-sdk/Core', '5.12.0'
  s.dependency 'InMobiSDK', '9.0.6'
end
