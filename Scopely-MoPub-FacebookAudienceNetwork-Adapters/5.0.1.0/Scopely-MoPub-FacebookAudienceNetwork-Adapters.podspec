...
Pod::Spec.new do |s|
s.name             = 'Scopely-MoPub-FacebookAudienceNetwork-Adapters'
s.version          = '5.0.1.0'
...
s.source           = { :git => 'https://github.com/mopub/mopub-ios-mediation.git', :commit => 'f6d67079772815d7f0d87175989ee94fbf7ad378' }
